...
(defun hide-lines (canvas x y cz lower-y upper-y
  ...
  #+:use-decl(declare (inline show-line aref + - / * sqrt truncate))
...
(defun show-line (canvas x1 y1 x2 y2 x-origin y-origin
  ...
  #+:use-decl(declare (fixnum x1 y1 x2 y2 mx my col2)
           (inline aref + - / * sqrt truncate round))
   #-:use-decl(declare (inline canvas-move-to canvas-draw-to
                   update-border)
...
(defun update-border (border x1 y1 x2 y2 s dl nl)
  #+:use-decl(declare (inline aref + - / * ))
  #-:use-decl(declare (inline update-line)
                        (optimize (speed 3) (safety 0)
                                  (space 0) (compilation-speed 0))
                        )
...
(defun fast-hide-lines (canvas x y cz lower-y upper-y
                               ...
                               mx my
                               a c ncol aa depth-cue? color-table)
  #+:use-decl(declare  (inline aref + - / * sqrt truncate ))
  #-:use-decl(declare (inline fast-show-line)
                        (optimize (speed 3) (safety 0)
                                  (space 0) (compilation-speed 0))
                        )
...
(defun fast-show-line (canvas x1 y1 x2 y2 x-origin y-origin
  ...
  #+:use-decl(declare (fixnum x1 y1 x2 y2 mx my col2)
           (inline aref + - / * sqrt truncate round ))
  #-:use-decl(declare (inline fast-move-to fast-line-to
                                update-border)
                        (optimize (speed 3) (safety 0)
                                  (space 0) (compilation-speed 0))
                        )
