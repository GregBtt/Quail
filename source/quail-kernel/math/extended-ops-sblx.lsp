...
#+:use-define-const(qk::define-constant  +infinity   '+infinity  "Represents positive infinity.")
#+:use-define-const(qk::define-constant   infinity   '+infinity  "Represents positive infinity.")
#+:use-define-const(qk::define-constant  -infinity   '-infinity  "Represents negative infinity.")

#+:use-define-const(qk::define-constant NaN 'NaN "Not a number.")
